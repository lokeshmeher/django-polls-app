...
# A shortcut function to create questions.
...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_a_past_question(self):
        """
        Questions with pub_date in the past should be displayed on the
        index page.
        """
...
# TODO: Add tests for questions with no choices. Accordingly, ammend the views.
